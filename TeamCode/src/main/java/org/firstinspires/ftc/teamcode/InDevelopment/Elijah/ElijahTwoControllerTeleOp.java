...
@TeleOp(name="ElijahTwoControllerTeleOp")
///  for this teleop i decided to make a 2 controller teleop so we can have one person
///  control the active intake and one person controlling the shooting and driving


public class ElijahTwoControllerTeleOp extends OpMode {
    ...
    public void loop(){
        ...
        ///  one for  intake, another for shooting driving and transfer system possibly
            // Driving
        ...
        ///  instead of having one controller take his finger off of the stick Me and Josiah deceided
        /// to put the active intake onto one controll so josiah can drive and shoot
